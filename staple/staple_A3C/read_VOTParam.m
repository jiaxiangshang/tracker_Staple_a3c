function [ params_, im_, bg_area_, fg_area_, area_resize_factor_ ] = read_VOTParam( seq_path, sequence, start_frame )
% RUN_TRACKER  is the external function of the tracker - does initialization and calls trackerMain
    %% Read params.txt
    params = readParams('params.txt');
	%% load video info
	sequence_path = [seq_path,sequence];
    sequence_path = strcat(sequence_path,'/');
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Debug
